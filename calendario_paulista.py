...
num_rodada = 1
fo = open("calendario_paulista.html", "w")
while 1:
	html = request.urlopen(("http://globoesporte.globo.com/servico/esportes_campeonato/responsivo/widget-uuid/2776d78a-38ac-4982-85b1-2389ff26f468/fases/primeira-fase-campeonato-paulista-2018/rodada/%i/jogos.html"%num_rodada))
