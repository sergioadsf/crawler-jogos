...
num_rodada = 1
fo = open("calendario_carioca.html", "w")
while 1:
	html = request.urlopen(("http://globoesporte.globo.com/servico/esportes_campeonato/responsivo/widget-uuid/2bcee051-4e56-4ef5-94a4-e0a475ba56dd/fases/primeira-fase-campeonato-carioca-2018/grupo/2057/rodada/%i/jogos.html"%num_rodada))
